...
class Sidebar extends React.Component {
  ...
  render() {
    const buttonImg = (this.state.intervalHandler) ? "https://res.cloudinary.com/dq5kxnx9d/image/upload/v1491778125/pause_fdkwav.png" : "http://res.cloudinary.com/dq5kxnx9d/image/upload/v1491778125/play-button_yg1xeu.png";
